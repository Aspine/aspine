...
*/
				...
				/***/ 271: /***/ function (
					...
					var GcalEventSource = /** @class */ (function (_super) {
						...
						GcalEventSource.prototype.fetch = function (
							start,
							end,
							timezone
						) {
											...
											ajaxSettings,
											{
												...
												success: function (
													...
													if (responseData.error) {
														...
														rawEventDefs =
															_this.gcalItemsToRawEventDefs(
																responseData.items,
																requestParams.timeZone
															);
														successRes =
															fullcalendar_1.applyAll(
																onSuccess,
																_this,
																[
																	responseData,
						...
						GcalEventSource.prototype.gcalItemsToRawEventDefs =
							function (items, gcalTimezone) {
								var _this = this;
								return items.map(function (item) {
									return _this.gcalItemToRawEventDef(
										item,
										gcalTimezone
									);
								});
							};
						GcalEventSource.prototype.gcalItemToRawEventDef =
							function (item, gcalTimezone) {
								var url = item.htmlLink || null;
								// make the URLs for each event show times in the correct timezone
								if (url && gcalTimezone) {
									url = injectQsComponent(
										url,
										'ctz=' + gcalTimezone
									);
								}
								...
								if (
									typeof item.extendedProperties ===
										'object' &&
									typeof item.extendedProperties.shared ===
										'object'
								) {
									extendedProperties =
						...
						GcalEventSource.prototype.buildRequestParams =
							function (start, end, timezone) {
								var apiKey =
						...
						GcalEventSource.prototype.reportError = function (
							...
							var calendarOnError = calendar.opt(
								'googleCalendarError'
							);
							...
							if (this.googleCalendarError) {
								this.googleCalendarError.apply(
									calendar,
									errorObjs
								);
							}
						...
						GcalEventSource.prototype.applyManualStandardProps =
							function (rawProps) {
								var superSuccess =
						...
						GcalEventSource.prototype.applyMiscProps = function (
							rawProps
						) {
