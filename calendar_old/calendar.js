...
let calendar_list = [
	{
		name: 'aspine',
		color: 'red',
		id: 'hvkmlf3u8blqksh7rtv86vfae0@group.calendar.google.com'
	},
	{
		name: 'holidays',
		color: 'blue',
	...
	},
	{
		name: 'cpsd',
		color: 'green',
		id: 'jc437n16ruh7ecbctl38ihmhb2k0bmfp@import.calendar.google.com'
	}
];
...
function add_calendar() {
	...
	$.post('/add-calendar', $('#add-calendar').serialize(), function (data) {
		...
		$('p#add-calendar-error').html(
			`Failed to add calendar: ${$('#add-calendar input[name=name]').val()}`
		);
	});
